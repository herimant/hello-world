...
def my_job():
    ...
    posts = Post.objects.filter(dateCreation__gte=last_week).order_by('-dataCreation')
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        scheduler.add_job(
            my_job,
            trigger=CronTrigger(day_of_week="fri", hour="18", minute="00", timezone=settings.TIME_ZONE),
            id="my_job",
            max_instances=1,
